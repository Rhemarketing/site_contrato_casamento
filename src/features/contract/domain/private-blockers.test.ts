...
it("mostra revisão pendente e deixa de tratá-la como bloqueio após liberação válida", () => {
  ...
  expect(privateBlockers(catalog, data).filter(b => b.id.endsWith("-review"))).toHaveLength(0);
  data.answers.Q103 = "C";
