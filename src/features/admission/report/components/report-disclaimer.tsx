  ...
  return (
    <footer className="mt-12">
      <Card className="p-6 sm:p-8">
        ...
        <p className="mt-3 text-muted">Um próximo passo poderá incluir a participação do seu cônjuge para identificar convergências e diferenças de percepção. Essa participação ainda não está disponível nesta etapa.</p>
